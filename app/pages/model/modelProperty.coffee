...
<span ng-if=\"descriptor.type == \'enum\'\">
  <select ng-model=\"value[name]\" ng-options=\"item for item in descriptor.values\">
    <option class=\"placeholder\" value=\"\">-- choose {{name}} --</option>
  </select>
</span>
<span ng-switch=\"descriptor\">
  ...
  <input ng-switch-when=\"list\" ng-model=\"value[name]\" placeholder=\"{{descriptor}}\" validate-range descriptor=\"descriptor\">
